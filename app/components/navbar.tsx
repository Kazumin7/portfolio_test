...
const NavBar = () => {
  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
      ...
      ${isScroll ? "bg-[rgba(255,255,255,0.5)] backdrop-blur-lg shadow-sm": ""}`}>
        <a href="#top">
        ...
        ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50"}`}>
            ...
            <li><a className='font-Ovo' href="#sniffer">STS2sniffer</a></li>
        ...
        top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500'>
            ...
            <li><a onClick={closeMenu} href="#sniffer">STS2sniffer</a></li>
